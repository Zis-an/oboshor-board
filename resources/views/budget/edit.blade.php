...
@section('main')
    <section class="content-header">
        <div class="container-fluid d-flex justify-content-between">
            <h4>Update Budget</h4>
            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add More</button>
        </div>
    </section>
    <section class="card">
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-6">
                    ...
                    {{Form::select('financial_year_id', $financialYears, $budget->financial_year_id,
                            ['class' => 'form-control', 'placeholder' => 'Select Financial Year', 'disabled' => 'disabled'])}}
                </div>
            </div>
        </div>
            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{!! Form::text('amount', $budget->amount, ['class' => 'form-control', 'id' => 'total-amount', 'readonly']) !!}</td>
                    </tr>
                    </tfoot>
                </table>
            </div>
