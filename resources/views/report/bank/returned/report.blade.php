...
<div class="card">
    <div class="card-body">
        <div class="row align-items-end">
            <div class="col-sm-12"><h2>Return Report</h2></div>
            <div class="col-sm-4">
...
$(document).ready(function () {
    ...
    $(document).on('click', '#export_btn_pdf', function () {
        ...
        let url = `/returned-items-report-export?type=pdf&account=${account}&date=${date}`
    ...
    $(document).on('click', '#export_btn_excel', function () {
        ...
        let url = `/returned-items-report-export?type=excel&account=${account}&date=${date}`
